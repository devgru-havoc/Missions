...
_player createDiaryRecord ["features", ["Vehicle Spawners", "
    ...
    <br/>The main base has a <marker name = 'HAVOC_Pisces_vehicleSpawnerMarker'>vehicle spawner</marker> that allows you to spawn and delete various ground vehicles.
