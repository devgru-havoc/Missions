 ...
 *
 * Example:
 * [controller, stretcher] call HAVOC_Pisces_Medical_fnc_specific_bodyPartActions
 */
...
private _actions = [];
{
    ...
    private _bodyPartAction = [
        ...
        {},
        {true},
        {(_this select 2) call HAVOC_Pisces_Medical_fnc_specific_projectileTypeActions},
